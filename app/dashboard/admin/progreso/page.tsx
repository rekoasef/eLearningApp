            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex justify-between items-center mb-8 flex-wrap gap-4">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Link href="/dashboard/admin/usuarios/nuevo" className="flex items-center gap-2 bg-blue-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-blue-700 transition-colors">
                                ...
                                {filteredProgress.map((progress) => (
                                    <tr className="border-b border-gray-800 hover:bg-[#1A1A1A]" key={`${progress.user_id}-${progress.course_id}`}>
                                        <td className="p-4 font-medium text-white">
                                            <Link href={`/dashboard/admin/progreso/${progress.user_id}`} className="hover:text-[#FF4500] transition-colors group">
